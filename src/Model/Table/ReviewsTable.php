...
class ReviewsTable extends AppTable
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->allowEmpty('question1_evaluation');

        $validator
            ->allowEmpty('question2');
        $validator
            ->allowEmpty('question2_evaluation');

        $validator
            ->allowEmpty('question3');
        $validator
            ->allowEmpty('question3_evaluation');

        $validator
            ->allowEmpty('question4');
        $validator
            ->allowEmpty('question4_evaluation');

        $validator
            ->allowEmpty('question5');
        $validator
            ->allowEmpty('question5_evaluation');
    ...
    public function findByDelFlgOrderById($wheres = null, $limit = null) {
        ...
        $options['fields'] = [
            ...
            'Reviews.question1_evaluation',
            'Reviews.question2',
            'Reviews.question2_evaluation',
            'Reviews.question3',
            'Reviews.question3_evaluation',
            'Reviews.question4',
            'Reviews.question4_evaluation',
            'Reviews.question5',
            'Reviews.question5_evaluation',
            'Reviews.question6',
            'Reviews.nickname',
            'Reviews.age',
            'Reviews.sex',
