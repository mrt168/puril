...
class ReviewsController extends AdminAppController {
	...
	private static $CSV_INDEX = array(
			...
			,5=> 'question2'				// 痛みへの配慮はいかがでしたか？
			,6=> 'question3'				// スタッフの態度、対応はいかがでしたか？
			,7=> 'question4'				// 店舗の雰囲気、設備、清潔感はいかがでしたか？
			,8=> 'question5'				// 待ち時間、予約対応はいかがでしたか？
			,9=> 'question6'				// 術前、術中、術後の対応はいかがでしたか？
			,10=> 'nickname'					// 定休日
			,11=> 'age'						// 年齢
			,12=> 'sex'						// 性別
			,13=> 'instagram_account'		// Instagramアカウント
			,14=> 'twitter_account'			// Twitterアカウント
			,15=> 'post_date'				// 投稿日
			,16=> 'visit_date'				// 来店日
			,17=> 'title'					// 口コミ タイトル
			,18=> 'content'					// 口コミ 本文
