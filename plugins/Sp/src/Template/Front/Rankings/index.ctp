...
<body>
    ...
    <ul class="content-base ranking-category">
        <li class="ranking-category-item-wrap"><a class="plain-link ranking-category-item" href="<?= Router::url('/datsumou/' . URLUtil::RANKING . "/salon") ?>"><i class="fas fa-crown ranking-category-item-icon"></i>
                <div class="ranking-category-item-text">全国の脱毛サロンの人気ランキング</div><i class="fas fa-chevron-right right-side-arrow"></i>
            </a></li>
        <li class="ranking-category-item-wrap"><a class="plain-link ranking-category-item" href="<?= Router::url('/datsumou/' . URLUtil::RANKING . "/clinic") ?>"><i class="fas fa-crown ranking-category-item-icon"></i>
                <div class="ranking-category-item-text">全国の医療脱毛の人気ランキング</div><i class="fas fa-chevron-right right-side-arrow"></i>
            </a></li>
    ...
    <div class="Search__breadcrumbs">
        <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
            ...
            ?>
                        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                            <span itemprop='name' class='name'><?php echo $pankuzu['val'] ?>口コミランキング</span>
                    ...
                    ?>
                    <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                        <a itemtype="http://schema.org/Thing" itemprop="item" href="<?= $pankuzu['url'] . "/" ?>"><span itemprop="name" class="name"><?php echo $pankuzu['val'] ?><</span> </a> <meta itemprop="position" content="<?php echo $i + 2; ?>">
                    </li>
            <?php
                    $i++;
                }
